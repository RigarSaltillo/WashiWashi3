...
try {
    ...
    $sql="INSERT INTO DIRECCION_prueva (COD_POSTAL,ESTADO,MUNICIPIO,CIUDAD,TIPO_ASENTAMIENTO,ASENTAMIENTO, CABLE_OFICINA) VALUES('$valorB','$valorC','$valorD','$valorE','$valorF','$valorG','$valorH')";
    $conexion -> query($sql);
